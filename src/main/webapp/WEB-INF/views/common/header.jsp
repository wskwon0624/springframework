			  ...
			  <div class="container-fluid">
			    ...
			    <div>
			    	<c:if test="${login =='success'}">
			    		<a href="${pageContext.request.contextPath}/ch07/sessionLogout" class="btn btn-outline-success btn-sm">로그아웃</a>
			    	</c:if>
			    	<c:if test="${login!='success'}">
			    		<a href="${pageContext.request.contextPath}/ch07/sessionLoginForm" class="btn btn-outline-success btn-sm">로그인</a>
			    	</c:if>
			    </div>
			  </div>
			</nav>
