	...
	<div class="d-flex flex-column vh-100 ">
		...
		<div class="flex-grow-1">
			<div class="d-flex row m-2 ">
				...
				<div class="col-md-8 ">
					<div class="card">
						<div class="card-header">게시물 상세</div>
						<div class="card-body">
							<p>번호:${board.bno}</p>
							<p>제목:${board.btitle}</p>
							<p>글쓴이:${board.mid}</p>
							...
							<a href="boardList" class="btn btn-outline-info btn-sm">목록</a>
							<a href="updateBoardForm?bno=${board.bno}" class="btn btn-outline-info btn-sm">수정</a>
							<a href="deleteBoard?bno=${board.bno}" class="btn btn-outline-info btn-sm">삭제</a>
						</div>
					</div>
				</div>
			</div>
